#' DEPRECIATED: NEW FUNCTION IS spheatNAMES() Geocode place names in a dataset
#'
...
#'
#'
#' spheatNames_dep("myDataframe", "myColWithPlaceNames", "mygoogleapikey")
#'
#' #Keeping all GADM shapefiles
#' spheatNames_dep("myDataframe", "myColWithPlaceNames", "mygoogleapikey", deleteGADM=FALSE)
#'
#' #You already have the GADM shapefiles and don't want to redownload or delete them
#' spheatNames_dep("myDataframe", "myColWithPlaceNames", "mygoogleapikey", oride=TRUE, deleteGADM=FALSE)
#'
#'
#' @export spheatNames_dep
spheatNames_dep <- function (dataset, colname, googleapikey, oride=FALSE, deleteGADM=TRUE)  {
  replacebug <-"n"
  dfname <- get(dataset)
